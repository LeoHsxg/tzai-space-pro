...
const NavBar = () => {
  ...
  return (
    <div
      className={`lg:hidden flex w-full h-18 px-8 py-4 md:h-16 justify-between items-center sticky top-0 z-50 bg-[#F3F3F3] md:border-solid border-b-2 border-gray-200 transition-shadow duration-200 ${
